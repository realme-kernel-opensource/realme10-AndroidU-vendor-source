            ...
            struct snd_ctl_elem_value *ucontrol)
{
    ...
    ucontrol->value.integer.value[0] = cfg->spin_delay;
            ...
            struct snd_ctl_elem_value *ucontrol)
{
    ...
    cfg->spin_delay = ucontrol->value.integer.value[0];
            ...
            struct snd_ctl_elem_value *ucontrol)
{
    ...
    queue_delayed_work(cfg->spin_wq,&cfg->spin_work,
                       msecs_to_jiffies(cfg->spin_delay));
...
static const struct snd_kcontrol_new fsm_snd_controls[] =
{
    ...
    SOC_SINGLE_EXT("FSM_Delay", SND_SOC_NOPM, 0, 360, 0,
